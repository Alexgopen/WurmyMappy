...
public final class MapDataV2 {
    ...
    MapDataV2(String root) throws IOException {
    ...
    MapDataV2(String root, int powerOfTwo) throws IOException {
    ...
    /**
     * Gets the surface mesh.  Use with caution.
     * 
     * @return surfaceMesh
     */
    public MeshIO getSurfaceMesh() {
     ...
     * 
     * @param desiredPowerOfTwo desired output image power of two, or map power of two if it is lower than this value. Must at least 9.
     * @return map image
     */
    public BufferedImage createMapDump(int desiredPowerOfTwo) {
        if (desiredPowerOfTwo < 9) {
            throw new IllegalArgumentException("Desired power of two is smaller than 9.");
        }
    ...
    public void saveChanges() {
        ...
        try {
            ...
            Logger.getLogger(MapDataV2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
